...
import BasePages.DriverSingleton;
import WebPages.*;
...
public class buyMeTest {
    ...
    String name = "noa";
    String mail = "noaa476@gmail.com";
    String password = "noa1234";
    ...
    @BeforeClass
    public void runOnce() {
        String cwd = System.getProperty("user.dir");        // name your test and add description
...
driver.get("https://buyme.co.il/");
    ...
    public void introAndRegistration() {
        try {
            loginPage.register();
            Assert.assertEquals(name, driver.findElement(By.className("ember-view ember-text-field")).getText());
    ...
    public void enterBusinessAndAmount() {
        try {
            String url = "https://buyme.co.il/search?budget=4&category=16&region=13";
    ...
    public void enterHowToSend() {
        try {
            String senderName = "noaa476@gmail.com";
